...
setwd("C:\\Users\\Gabriel\\Desktop\\Cursos\\MachineLearning\\Cap05-Regressao_II")
getwd()
...
credito_dataset <- read.csv("dados/credit_dataset_final.csv", header = TRUE, sep = ",")
